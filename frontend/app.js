...
async function cargarServicios() {
    try {
        const response = await fetch('https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/servicios');
...
async function manejarSaludo(e) {
    ...
    try {
        const response = await fetch(`https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/bienvenido/${nombre}`);
        const data = await response.json();
...
async function manejarRegistro(e) {
    ...
    try {
        const response = await fetch('https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/register', {
            method: 'POST',
...
async function manejarLogin(e) {
    ...
    try {
        const response = await fetch('https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/login', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ correo, contrasena })
        });
...
async function manejarAgregarServicio(e) {
    ...
    try {
        const response = await fetch('https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/servicios/agregar', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function manejarRegistrarMascota(e) {
    ...
    try {
        const response = await fetch('https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/mascotas/registrar', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function manejarBuscarMascota(e) {
    ...
    try {
        const response = await fetch(`https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/mascotas/${correo}`);
        const data = await response.json();
...
async function manejarBuscarReporte(e) {
    ...
    try {
        const response = await fetch(`https://veterinaria-andrea-salas-backend-506160926608.europe-west1.run.app/mascotas/reporte/${correo}`);
        const data = await response.json();
        renderReporte(data);
    } catch (error) {
